...
#### Plugins
 ...
 ```shell
 plugins=(atom autojump aws bower brew bundler composer common-aliases docker encode64 gem git git-extras github httpie jsontools last-working-dir meteor node npm osx rails ruby rvm sublime vagrant wd colored-man colorize)
 ```
